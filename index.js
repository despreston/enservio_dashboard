...
var urls = {
	qa: {
		qa11: [{ name: 'CE_SC', url: 'http://qa11.contentsexpress.lan/release_info.json' },
			   ...
			   { name: 'CE_DB', url: 'http://qa11.contentsexpress.lan/cedb/release_info.json' }],
		qa12: [{ name: 'CE_SC', url: 'http://qa12.contentsexpress.lan/release_info.json' },
			   ...
			   { name: 'CE_DB', url: 'http://qa12.contentsexpress.lan/cedb/release_info.json' }],
		qa21: [{ name: 'CE_SC', url: 'http://qa21.contentsexpress.lan/release_info.json' },
			   ...
			   { name: 'CE_DB', url: 'http://qa21.contentsexpress.lan/cedb/release_info.json' }],
		...
		qa31: [{ name: 'CE_SC', url: 'http://qa31.contentsexpress.lan/release_info.json' },
			   ...
			   { name: 'CE_DB', url: 'http://qa31.contentsexpress.lan/cedb/release_info.json' }],
		qa32: [{ name: 'CE_SC', url: 'http://qa32.contentsexpress.lan/release_info.json' },
			   ...
			   { name: 'CE_DB', url: 'http://qa32.contentsexpress.lan/cedb/release_info.json' }],
		qa41: [{ name: 'CE_SC', url: 'http://qa41.contentsexpress.lan/release_info.json' },
			   ...
			   { name: 'CE_DB', url: 'http://qa41.contentsexpress.lan/cedb/release_info.json' }],
		qa42: [{ name: 'CE_SC', url: 'http://qa42.contentsexpress.lan/release_info.json' },
			   ...
			   { name: 'IntegrationWS', url: 'http://qa42.contentsexpress.lan/integrationws/release_info.json' },
			   { name: 'CE_DB', url: 'http://qa42.contentsexpress.lan/cedb/release_info.json' }]
	},
	dev: {
		dev01: [{ name: 'CE_SC', url: 'http://dev01.contentsexpress.lan/release_info.json' },
			    { name: 'IAP_SC', url: 'http://dev01.contentsexpress.lan/newiap/release_info.json' },
			    { name: 'Admin_SC', url: 'http://dev01.contentsexpress.lan/adminsc/release_info.json' },
			    { name: 'claimsws', url: 'http://dev01.contentsexpress.lan/claimsws/release_info.json' },
			    { name: 'ce_web', url: 'http://dev01.contentsexpress.lan/web/release_info.json' },
			    { name: 'ce_app', url: 'http://dev01.contentsexpress.lan/app/release_info.json' },
			    { name: 'adminws', url: 'http://dev01.contentsexpress.lan/adminws/release_info.json' },
			    { name: 'IDP', url: 'http://dev01.contentsexpress.lan/idp/release_info.json' },
			    { name: 'IntegrationWS', url: 'http://dev01.contentsexpress.lan/integrationws/release_info.json' }], 
		dev02: [{ name: 'CE_SC', url: 'http://dev02.contentsexpress.lan/release_info.json' },
		...
		dev04: [{ name: 'CE_SC', url: 'http://dev04.contentsexpress.lan/release_info.json' },
			    { name: 'IAP_SC', url: 'http://dev04.contentsexpress.lan/newiap/release_info.json' },
			    { name: 'Admin_SC', url: 'http://dev04.contentsexpress.lan/adminsc/release_info.json' },
			    { name: 'claimsws', url: 'http://dev04.contentsexpress.lan/claimsws/release_info.json' },
			    { name: 'ce_web', url: 'http://dev04.contentsexpress.lan/web/release_info.json' },
			    { name: 'ce_app', url: 'http://dev04.contentsexpress.lan/app/release_info.json' },
			    { name: 'adminws', url: 'http://dev04.contentsexpress.lan/adminws/release_info.json' },
			    { name: 'IDP', url: 'http://dev04.contentsexpress.lan/idp/release_info.json' },
			    { name: 'IntegrationWS', url: 'http://dev05.contentsexpress.lan/integrationws/release_info.json' }],
		dev05: [{ name: 'CE_SC', url: 'http://dev05.contentsexpress.lan/release_info.json' },
			    { name: 'IAP_SC', url: 'http://dev05.contentsexpress.lan/newiap/release_info.json' },
			    { name: 'Admin_SC', url: 'http://dev05.contentsexpress.lan/adminsc/release_info.json' },
			    { name: 'claimsws', url: 'http://dev05.contentsexpress.lan/claimsws/release_info.json' },
			    { name: 'ce_web', url: 'http://dev05.contentsexpress.lan/web/release_info.json' },
			    { name: 'ce_app', url: 'http://dev05.contentsexpress.lan/app/release_info.json' },
			    { name: 'adminws', url: 'http://dev05.contentsexpress.lan/adminws/release_info.json' },
			    { name: 'IDP', url: 'http://dev05.contentsexpress.lan/idp/release_info.json' },
			    { name: 'IntegrationWS', url: 'http://dev05.contentsexpress.lan/integrationws/release_info.json' }],
	},
	uat: {
